...
static int wmt_plt_probe(struct platform_device *pdev)
{
	extern void wmt_plat_gpio_init(struct platform_device *pdev);
	wmt_plat_gpio_init(pdev);
	return 0;
}

static int wmt_plt_remove(struct platform_device *pdev)
{
	return 0;
}
