...
char *fm_ver = "VER:201304240130";
fm_u32 g_dbg_level = 0xfffffff4;  // Debug level of FM
...
static long fm_ops_ioctl(struct file *filp, fm_u32 cmd, unsigned long arg)
{
    ...
    case FM_IOCTL_TUNE: {
        struct fm_tune_parm parm;
        WCN_DBG(FM_NTC | MAIN, "%s FM_IOCTL_TUNE:0\n", fm_ver);
	...
	case FM_IOCTL_SOFT_MUTE_TUNE:
	{
        ...
        WCN_DBG(FM_NTC | MAIN,"%s ......FM_IOCTL_SOFT_MUTE_TUNE......\n", fm_ver);
